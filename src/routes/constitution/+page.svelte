...
<div class="constitution">
    ...
    <p>13 Bench (Any further expansions will be put to a league vote)</p>

    <p>3 IR Spots (Player must be labeled as IR, Out, or Covid)</p>
    
        <h4 bind:this={oneOneOne}>1.1.1 Position Maximums</h4>
        
        <div class="subBlock">
            <img src="https://miro.medium.com/v2/resize:fit:996/0*zEU6Xyz5z72H6Lhh.gif" alt="AyyyyNoLimitz" />
        </div>
    ...
    <div class="subBlock">
        ...
        <ul>
            <li>First Offense – Public shaming and the 8 hot dog challenge must be completed at a participating Wienerschnitzel location.</li>
            ...
            <li>Third Offense – League member will be removed from SFO immediately as well as they must purchase jetskis for all other league members as an acceptable apology.</li>
        </ul>
        ...
        <p>The commissioner will err on the side of letting owners manage their teams the way they see fit. Any collusion will need to be clear. The commissioner rules with an iron fist; never forget that. </p>
    </div>

    <h4 bind:this={oneTwoTwo}>1.2.2 Lending Players Prohibition</h4>
    <div class="subBlock">
        <p>We understand buyer's remorse is a reality, but no slimey "loaning" of players will be tolerated. Should the always active league advisory board's third-party investigators find you liable you will be punished. Punishment includes a full handover of all social media accounts to the league for one post of their choosing. </p>
    </div>
    
    <h4 bind:this={oneTwoThree}>1.2.3 Trade Deadline</h4>
    <div class="subBlock">
        <p>The trade deadline is before the final snap of the week 11 games of the NFL season.</p>
    </div>
    
    <h4 bind:this={oneTwoFour}>1.2.4 Trade Restrictions</h4>
    <div class="subBlock">
        <p>You will not be able to trade draft picks that are more than 3 drafts away. You may only trade FAAB $ from the current season.</p>
    </div>
    
    <h4 bind:this={oneTwoFive}>1.2.5 Veto/Trade Process</h4>
    <div class="subBlock">
        <p>The almighty commissioner rules with an iron fist.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $100. $0 bids are allowed. Bids will process daily and open free agency on Sundays.</p>
    ...
    <p>The draft order each year will be a linear draft in reverse order of the previous year’s regular season standings. Tiebreakers will be decided by the Max Points For accumlated by the team that season. Playoff team's draft order is decided by lower scores the fateful week they exit the playoffs. </p>

    <h3 bind:this={twoTwo}>2.2 Rookie Drafts</h3>
    <p>Rookie drafts will consist of 4 round of drafting. 10 minutes to pick (or trade) are alloted for the 1st round, 3 minutes for the 2nd round, and addtionally 1 minute for the 3rd and 4th rounds. </p>
    <p>The first and second rounds will consist of only drafting rookies, and beginning in the third round veterans on the waiver wire are also added to the draft eligible pool to be selected.</p>
    
    <h3 bind:this={twoThree}>2.3 Draft Day Trades</h3>
    <p>If a trade involving the current selection is being made during the draft it must be completed within the alloted draft time.</p>
    
    <h2 class="sectionHeading" bind:this={three}>Section 3 Scoring System</h2>

    <h3 bind:this={threeOne}>3.1 Scoring System</h3>
    <p>The league scoring system breakdown is listed in Sleeper (Typical PPR Scoring). The scoring system will never change without a majority league vote.</p>
    
    <h2 class="sectionHeading" bind:this={four}>Section 4 Postseason</h2>
    
    <h3 bind:this={fourOne}>4.1 Playoffs</h3>
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 15. The top 6 teams that finish with the best records will receive a playoff berth. The top 2 teams that will receive a bye week in the first round of the playoffs. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
    ...
    <ol>
        ...
        <li>League vote on who's hotter</li>
    </ol>

    <h2 class="sectionHeading" bind:this={five}>Section 5 Tanking Policy</h2>
    
    <h3 bind:this={fiveOne}>5.1 League Tanking Policy</h3>
    <p>No team may intentionally leave starting roster spots empty. If your team sucks, they suck! That's okay. Sucking is innate to some. Any evidence of intentionally leaving roster spots empty or benching high profile players is subject to punishment, including but not limited to the forfeiture of draft selections.</p>
    ...
    <p>When a manager needs to be replaced, the commissioner will find a suitable candidate with some connection to at least a portion of the existing managers. Priority will be placed on managers who have international sex appeal.</p>
    
    <h3 bind:this={sixThree}>6.3 Replacement Incentive</h3>
    <p>In the event that a manager chooses to quit the league or is removed by a comissioner, an incoming manager's first year buy-in is comped as well as any future year's in which they do not own their own 1st round draft picks.</p>

    <h2 class="sectionHeading" bind:this={seven}>Section 7 League Finances</h2>
    
    <h3 bind:this={sevenOne}>7.1 League Dues</h3>
    <p>League dues are set at {dues}$. Dues are safely stored in the commissioner's craps bank roll and collection will be sent out no later than draft day. However, appeals may be filed and must be approved by the league's advisory board. In the event that a manager fails to pay before the deadline, a 10% penalty will be addd to their payment and will go towards the payouts at the end of the year.</p>
    ...
    <p>A ⅔ majority vote is required in order to raise league dues. In the event that a manager is no longer financially comfortable with the buyin, finding a co-manager to split the cost is reccommended.</p>
